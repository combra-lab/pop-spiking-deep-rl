...
#include "nxsdk.h"
#include "encoder.h"
#define input_num 170 // Different for different Mujoco Task
#define bias_num 3
...
void run_encoder(runState *s)
{
    ...
    */
    if(time % epoch == 1)
    {
        ...
        int tmp_input[44];
        readChannel(InputChannelId, &tmp_input, 44);
        ...
        en_act[168] = tmp_input[42];
        en_spike_v[168] = en_act[168];
        en_act[169] = tmp_input[43];
        en_spike_v[169] = en_act[169];
    }
    /*
